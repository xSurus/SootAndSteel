...
public class GamePadInputProvider(int controllerIndex) : AbstractInputProvider()
{
    ...
    public override bool IsCarryJustPressed() => currentGamePadState.Buttons.A == ButtonState.Pressed &&
                                                 previousGamePadState.Buttons.A == ButtonState.Released;

    public override bool IsCarryHeld() => currentGamePadState.Buttons.A == ButtonState.Pressed;
